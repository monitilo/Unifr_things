...
#        self.graph.addItem(self.lr)
    ...
    def save_goodSelection_traces(self):
        ...
        print("save goodselection traces")
        print(self.selection)
        print("\n")
        print(self.selection[int(self.traceSlider.value())-1:int(self.traceSlider.value())+1])
        self.next_trace()
        self.update_trace()
    ...
    def save_badSelection_traces(self):
        self.selection[int(self.traceSlider.value()), 1] = -1
        self.colorgraph = (250, 150, 50)
        print("save badselection traces")
        print(self.selection[int(self.traceSlider.value())-1:int(self.traceSlider.value())+1])
        self.next_trace()
        self.update_trace()
        self.update_threshold()
